...
const corridor1Floor2 = 'assets/Tolstoi/2korrus/3_2_209-Edit.jpg'
const corridor2Floor2 = 'assets/Tolstoi/2korrus/3_2_koridor 1.1-Edit.jpg'
...
const roomImageFloor3 = 'assets/Tolstoi/3.korrus/3_3_315-Edit.jpg'
...
const corridorPano1 = new PANOLENS.ImagePanorama(corridor1Floor2)
const corridorPano2 = new PANOLENS.ImagePanorama(corridor2Floor2)
...
const roomPanoFloor3 = new PANOLENS.ImagePanorama(roomImageFloor3)
...
var lookAtPositionsKelder = [
  ...
  new THREE.Vector3(4485.81, -876.16, 2017.92 ),//1 hallway1 ......
 ];
...
doorPano.link(lobbyPano4, new THREE.Vector3(-4952.57, 396.51, -547.58));
...
// 3 punkt koridoris
hallway2Pano.link(hallway3Pano, new THREE.Vector3(-4680.54, -1712.73, 246.04));
hallway2Pano.link(roomPanoFloor3, new THREE.Vector3(59.12, -1769.10, 4669.54)); //
...
//ruumist 315 välja
roomPanoFloor3.link(hallway2Pano, new THREE.Vector3(4516.35, -2128.79, 71.82)); //
...
// teiselt korruselt kolmandale
stairsPano2.link(stairsPano, new THREE.Vector3(-2667.00, -945.28, 4109.74));

stairsPano.link(stairsPano2, new THREE.Vector3(1183.66, -3283.62, 3576.61));
